                ...
                <form className="px-8 pt-6 pb-8 mb-4 bg-white dark:bg-gray-800 rounded">
                    ...
                    <div className="mb-4 md:flex md:justify-between">
                        <div className="mb-4 md:mr-2 md:mb-0 ">
                            ...
                            <input
                                className="w-[41vw] px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border border-red-500 rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                id="password"
                                type="password"
                                placeholder="******************"
                            />
                    ...
                    <div className="text-center">
                        <Link href="/sign-up" className="inline-block text-sm text-blue-500 dark:text-blue-500 align-baseline hover:text-blue-800">
